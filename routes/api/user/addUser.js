...
Router.post('/',function(req,res){
    ...
    const sqlInsert = 'INSERT INTO users (user_id, name, age, phone, email, sex, personal_signature, creat_time) VALUES(?,?,?,?,?,?,?,?)';
    const addParams = [user_id, name, age, phone, email, sex, personal_signature, creat_time];
